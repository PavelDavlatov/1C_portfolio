...
| | |
| :-- | :-- |
| **Обработка генерации данных** | **Отчет «Остатки товаров»** |
| ![Генерация](Скриншоты/Генератор_данных.png) | ![Остатки](Скриншоты/Отчет_Остатки.png) |
| **Ведомость по взаиморасчетам** | **Печатная форма ТОРГ-12** |
| ![Ведомость](Скриншоты/Ведомость_взаиморасчетов.png) | ![ТОРГ-12](Скриншоты/Печатная_форма_ТОРГ12.png) |
