# Портфолио специалиста 1С:Предприятие

 **Цель:** Позиция специалиста технической поддержки/сопровождения 1С с возможностью профессионального роста и обучения.

---
## Образование 
- **Вуз**: Московский энергетический институт "МЭИ"
- **Специальность:** Прикладная информатика в экономике
- **Год окончания:** 2023
- **Сертификат:** "1С:Профессионал" по платформе 8.3
- **В процессе:** Подготовка к экзамену "1С:Профессионал" по конфигурации "Бухгалтерия 3.0"

---

### 📋 Обо мне

- Имею 3 года практического опыта ежедневной работы в типовой конфигурации "1С:CRM Стандарт", где занимаюсь контролем данных и самостоятельным исправлением ошибок в реквизитах.
- Прошел углубленный курс «Программист 1С» (390 часов) и осознанно выбираю путь в сопровождении, так как мне нравится разбираться в причинах сбоев, работать с типовыми конфигурациями и помогать пользователям решать их задачи.  
...
---
### Почему опыт разработки полезен в сопровождении

- Понимаю платформу изнутри: как проводятся документы, как формируются 
  движения регистров, почему возникают ошибки и расхождения — это позволяет 
  быстро находить причину обращения пользователя.
- Умею читать чужой код и разбираться в чужой конфигурации: не эскалирую 
  разработчикам то, что могу разобрать сам.
- Могу написать простую внешнюю обработку или отчёт для диагностики проблемы 
  или ускорения рутинной операции.
- Тестовые задания научили быстро вникать в незнакомую конфигурацию и ТЗ — 
  так же я буду вникать в базу нового клиента.
...
<table>
  ...
  <tr>
    ...
    <td><b>Регистр накопления Проданные туры </b></td>
  </tr>
  <tr>
    <td><img src="Скриншоты/Проект 1/Отчет-по-проданным-турам.png" width="400"></td>
    <td><img src="Скриншоты/Проект 1/Стоимость-туров.png" width="400"></td>
    <td><img src="Скриншоты/Проект 1/Регистр накопления Проданные туры.png" width="400"></td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td><img src="Скриншоты/Проект 2/Оборотно-сальдовая ведомость.png" width="300"></td>
    <td><img src="Скриншоты/Проект 2/Реализация товаров и услуг.png" width="300"></td>
  </tr>
</table>
<table>
  <tr>
  ...
  <tr>
    <td><img src="Скриншоты/Проект 2/Поступление товаров и услуг.png" width="400"></td>
    <td><img src="Скриншоты/Проект 2/Форма задачи.png" width="300"></td>
  </tr>
</table>
...
| Описание | Ссылка |
|:---|:---|
| Скриншоты | (https://github.com/PavelDavlatov/1C_portfolio/tree/main/Скриншоты/Проект%202)|
| Коды | (https://github.com/PavelDavlatov/1C_portfolio/tree/main/Код/Проект%202) |
| Конфигурация | https://github.com/PavelDavlatov/1C_portfolio/tree/main/Конфигурации |
---
...
<table>
  ...
  <tr>
    <td><img src="Скриншоты/Проект 3/Карточка товара.png" width="250"></td>
    <td><img src="Скриншоты/Проект 3/Счет от поставщика.png" width="250"></td>
    <td><img src="Скриншоты/Проект 3/Платежное поручение.png" width="250"></td>
    <td><img src="Скриншоты/Проект 3/Оплата поставщику.png" width="250"></td>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td><b>Оборотно-сальдовая ведомость</b></td>
  </tr>
  <tr>
    <td><img src="Скриншоты/Проект 3/Поступление товара.png" width="250"></td>
    <td><img src="Скриншоты/Проект 3/Счет покупателю.png" width="250"></td>
    <td><img src="Скриншоты/Проект 3/Поступление оплаты.png" width="250"></td>
    <td><img src="Скриншоты/Проект 3/Оборотно-сальдовая ведомость.png" width="250"></td>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td><b>Расходная накладная"</b></td>
    <td><b>Печатная форма документа"</b></td>
  </tr>
  <tr>
    <td><img src="Скриншоты/Проект 4/Номенклатура.png" width="250"></td>
    <td><img src="Скриншоты/Проект 4/Контрагенты.png" width="250"></td>
    <td><img src="Скриншоты/Проект 4/Расходная накладная.png" width="250"></td>
    <td><img src="Скриншоты/Проект 4/Печатная форма документа.png" width="250"></td>
  </tr>
</table>
---
...
| Описание | Ссылка |
|:---|:---|
| Скриншоты | (https://github.com/PavelDavlatov/1C_portfolio/tree/main/Скриншоты/Проект%204)|
| Коды | (https://github.com/PavelDavlatov/1C_portfolio/tree/main/Код/Проект%204) |
| Конфигурация | https://github.com/PavelDavlatov/1C_portfolio/tree/main/Конфигурации |
...
<table>
  <tr>
    <td><b>Отчет"Ведомость по взаиморасчетам"</b></td>
    <td><b>Отчет "Остатки товаров</b></td>
    <td><b>Список накладных</b></td>
    <td><b>Печатная форма ТОРГ-12</b></td>
  </tr>
  <tr>
    <td><img src="Скриншоты/Проект 5/Ведомость по взаиморасчетам.png" width="250"></td>
    <td><img src="Скриншоты/Проект 5/Остатки товаров.png" width="250"></td>
    <td><img src="Скриншоты/Проект 5/Список накладных.png" width="250"></td>
    <td><img src="Скриншоты/Проект 5/Печатная форма ТОРГ-12.png" width="250"></td>
  </tr>
</table>
...
| Описание | Ссылка |
|:---|:---|
| Скриншоты | (https://github.com/PavelDavlatov/1C_portfolio/tree/main/Скриншоты/Проект%205)|
| Коды | (https://github.com/PavelDavlatov/1C_portfolio/tree/main/Код/Проект%205) |
| Конфигурация | https://github.com/PavelDavlatov/1C_portfolio/tree/main/Конфигурации |
...
```text
1С_portfolio/
├── README.md - описание проектов: бизнес-задачи,реализация,технические решения
├── Скриншоты - скриншоты форм, отчетов и печатных форм
├── Конфигурации - выгрузки конфигураций (.cf) для запуска и проверки
├── Код - примеры кода по каждому проекту (модули,запросы,обработки).
```
## Контакты
